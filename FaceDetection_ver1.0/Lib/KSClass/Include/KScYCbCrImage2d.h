...
// attribute
public:
	KScData2dFloat* pRealData[KS_YCbCr_PLANE_NUM]; // original image pointer
	KScData2dFloat* pRealRoi [KS_YCbCr_PLANE_NUM]; // roi image pointer for copy mode
	KSdFloat*       pData    [KS_YCbCr_PLANE_NUM]; // access image pointer
	KSdFloat**      p2dArray [KS_YCbCr_PLANE_NUM]; // 2d Array
	KSdFloat**      pRoiData [KS_YCbCr_PLANE_NUM]; // roi image pointer
